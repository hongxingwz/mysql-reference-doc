...
Write a SQL query to find the cancellation rate of request made by unbanned clients between Oct 1, 2013 and Oct 3, 2013. For the above tables, your SQL query return the following rows with the cancellation rate being rounded to two decimal places.
